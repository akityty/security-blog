...
import konkon.service.impl.CategoryServiceImpl;
...
public class ApplicationConfig extends WebMvcConfigurerAdapter implements ApplicationContextAware {
  ...
  public DataSource dataSource() {
    ...
    dataSource.setUrl("jdbc:mysql://localhost:3306/blog-security?useUnicode=true&characterEncoding=UTF-8");
 ...
 /* @Override
  public void addFormatters(FormatterRegistry registry) {
    ...
    registry.addFormatter(new StringToLocalDateFormatter(applicationContext.getBean(EmployeeService.class)));
  }*/
  ...
  //rang buoc kich thuoc file up len
